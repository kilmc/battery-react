  ...
  it('matches snapshot', () => {
    expect(
      printMobileFirst(
        ...
        mobileFirstQueries(breakpointsConfig)
      )
    ).toMatchSnapshot();
  });
});
...
describe('printPerScreen', () => {
  it('matches snapshot', () => {
    expect(
      printPerScreen(
        {
          xs: [{ 'hide-xs': { display: 'none' } }],
          sm: [{ 'hide-sm': { display: 'none' } }],
          md: [{ 'hide-md': { display: 'none' } }],
          lg: [{ 'hide-lg': { display: 'none' } }]
        },
        perScreenQueries(breakpointsConfig)
      )
    ).toMatchSnapshot();
  });
});
